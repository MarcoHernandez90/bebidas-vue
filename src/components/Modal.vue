          ...
          >
            ...
            >
              <div>
                <div class="mt-3">
                  ...
                  <p class="text-lg text-gray-500">
                    {{ bebidas.receta.strInstructionsES ?? bebidas.receta.strInstructions }}
                  </p>
                </div>
              </div>
              <div class="mt-5 sm:mt-6 flex justify-between gap-4">
                <button
                  type="button"
                  class="w-full rounded bg-gray-600 p-2 font-bold uppercase text-white shadow hover:bg-gray-500"
                ...
                <button
                  type="button"
                  class="w-full rounded bg-orange-600 p-2 font-bold uppercase text-white shadow hover:bg-orange-500"
